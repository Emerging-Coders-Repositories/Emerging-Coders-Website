...
export default function EmergingCodersTestimonials(): React.ReactElement {
  ...
  return (
    <div className="w-full 4xl:max-w-9/12 mx-auto h-[150vh] text-white">
      <div className="h-full flex flex-col w-full 3xl:mx-auto">
        ...
        <div className="relative flex-1 flex justify-between w-full px-4 min-h-0">
          {columns.map((column, i) => (
            <div key={`col-${i}`} className="flex-1 max-w-md mx-2">
              <Marquee
          ...
          <div className="pointer-events-none absolute inset-0 z-10">
            {/* Left gradient */}
            <div className="absolute inset-y-0 left-0 w-50 bg-gradient-to-r from-black via-black to-transparent"></div>
            {/* Right gradient */}
            <div className="absolute inset-y-0 right-0 w-50 bg-gradient-to-l from-black via-black to-transparent"></div>
            {/* Top gradient */}
