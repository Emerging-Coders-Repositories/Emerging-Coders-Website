      ...
      <div className="h-full flex flex-col w-full 3xl:mx-auto">
        ...
        <div className="relative flex-1 flex justify-between w-full px-4 min-h-0">
          ...
          <div className="pointer-events-none absolute inset-0 z-10">
            {/* Left gradient */}
            <div className="absolute inset-y-0 left-0 w-65 bg-gradient-to-r from-black via-black to-transparent"></div>
            {/* Right gradient */}
            <div className="absolute inset-y-0 right-0 w-65 bg-gradient-to-l from-black via-black to-transparent"></div>
            {/* Top gradient */}
