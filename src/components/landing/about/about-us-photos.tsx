...
export default function AboutusPhotoGrid() {
  ...
  return (
    <div className="bg-black py-24 sm:py-32 min-h-screen min-w-10/12 mx-auto">
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row">
          <div className="lg:w-7/12 mb-10 lg:mb-">
            <div className="lg:top-8 flex justify-center flex-col items-center">
              <h2 className="text-5xl font-semibold -tracking-4 mb-6 text-white">
                About Emerging Coders
              </h2>
              <p className="font-mono text-sm leading-relaxed text-zinc-400 mb-4 w-lg">
              ...
              <p className="font-mono text-sm leading-relaxed text-zinc-400 mb-6 w-lg">
