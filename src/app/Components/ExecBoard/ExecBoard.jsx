...
export default function ExecBoard() {
    ...
    // Yearly executive and junior executive boards
    const execBoards = {
            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 px-10 mx-auto max-w-screen-2xl text-center lg:py-16 lg:px-6">
                    ...
                    <div className="mx-auto max-w-screen-sm">
                        <h3 className="mb-4 text-3xl tracking-tight font-bold text-gray-900 dark:text-white">Executive Board - {currentYear}</h3>
                    </div>
                    ...
                    <div className="mx-auto max-w-screen-sm lg:mb-4 mt-40">
                        <h3 className="mb-4 text-3xl tracking-tight font-bold text-gray-900 dark:text-white">Junior Executive Board</h3>
                    </div>
                    <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mb-8">
                            ...
                            {Object.keys(execBoards).map((year) => (
                                <button 
                                    ...
                                    className={`px-4 py-2 rounded-lg text-white ${
                                        currentYear === parseInt(year) ? "bg-gray-900 dark:bg-gray-700" : "bg-gray-500 dark:bg-gray-600"
