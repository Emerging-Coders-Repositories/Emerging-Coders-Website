    ...
    <main className="p-8 max-w-7xl mx-auto mt-36">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-3xl font-bold md:text-4xl text-white">
          Historical Emerging Coders Executive Boards
        </h1>
      </div>
      <p className="my-4 opacity-75 text-white max-w-xl">
        We value our past executive boards and the contributions they have made
        to our organization. Here is a list of our past executive boards. You
        can click on a name and be redirected to their LinkedIn profile if they
        have one available.
      </p>
      {historicalRoster.map((year, i) => (
