...
export default function HeroCodeEditor() {
  return (
    <div className="w-full px-4 md:px-8 lg:px-12">
      <div className="relative w-full max-w-7xl aspect-[10/5] min-h-[38rem]  mx-auto rounded-t-xl overflow-hidden shadow-2xl border-t border-l border-r border-white/10">
